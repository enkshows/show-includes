  ...
  <div class="descbox3"> 
   ...
   <div id="news3" >
     <div class="spImg" style="margin-bottom:10px;">
      <a href="../img/shows/acic/2014/jan/acic-sneakpeek-01.jpg"  target="_blank" title="Circuit.intermezzo Sneak Peek 03" >
        <img src="../img/shows/acic/2014/jan/acic-sneakpeek-01.jpg" width="480"  alt="Circuit.Intermezzo Sneak Peek">
      </a>
    </div>  
    <div class="spTxt">
