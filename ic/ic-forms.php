...
<div class="module-content-info">
  ...
  <?php include('../includes/ic/ic-form-exhibitor-app.php'); ?>

  <?php include('../includes/ic/ic-form-visit.php'); ?>

  <?php include('../includes/ic/ic-form-contact.php'); ?>

  <?php include('../includes/ic/ic-shows.php'); ?>
