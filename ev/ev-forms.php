...
<div class="module-content-info">
  ...
  <?php include('../includes/ev/ev-form-exhibitor-app.php'); ?>

  <?php include('../includes/ev/ev-form-visit.php'); ?>

  <?php include('../includes/ev/ev-form-contact.php'); ?>

  <?php include('../includes/ev/ev-shows.php'); ?>
