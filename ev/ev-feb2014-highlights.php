<div id="highlights" class="module">
  ...
  <div class="module-content" style="margin-top:0;">
    <h2 style="margin-bottom: 20px; margin-top: 20px">Retailer Testimonials</h2>

    <p class="testimonial">"The show is easy to shop and very convenient. Perhaps the greatest benefit was for the brands to receive input from the buyers so that they can make adjustments and complete the editing process before New York Market...For both the buyer and the brand this early exchange of ideas will help the market place be more successful. I'm happy I attended ENKVEGAS and I will be there again next season."</p>
    <h5 class="who">- Ron Herman, Owner, Ron Herman</h5> 

    <p class="testimonial">“The vibe of the show made it stand out…the Oasis theme was top notch. ENKVegas is a more relaxed and fun atmosphere where we tend to discover lines. Overall a great experience as usual.”</p>
    <h5 class="who">– Rita Manzelmann, senior buyer, Miss Jackson’s</h5>

    <p class="testimonial">"ENKVegas was a great place to accommodate all our buying needs for our stores. It was a great place to reconnect with current vendors and also see what else is going on in the fashion industry from apparel, jewelry & accessories."</p>
    <h5 class="who">- Wendi Shelist, owner, The Denim Lounge</h5>

    <p class="testimonial" style="letter-spacing: -.01em">"The collections that  ENKVegas assembled for Resort/Spring 2014...nothing short of fantastic. There was a cohesiveness to the assortment that made it easy to curate a collection that my clients will respond to immediately and I know will fly off the racks."</p>
    <h5 class="who">- Aardi Najmabadi, owner, Vasari</h5>
  ...
  <div class="module-content" style="margin-top:0;">
    ...
    <div class="descbox1"> 
      <div id="news5">
        An interactive lookbook featuring a hand selected group of ENKVEGAS designers.
        <br/>
        <br/>
        <a href="http://enkvegaslookbook.enkshows.com/" target="_blank">See Lookbook</a>
        <br />  <br />
      </div>
    </div>    
    <div style="margin-top:20px;" class="text-foot"></div>  
  ...
  <div class="module-content" style="margin-top:0;">
    ...
    <div class="imagePressBox">
      ...
      <div class="element">   
        <a href="http://www.wwd.com/markets-news/markets-features/things-to-know-at-the-las-vegas-shows-7442617?module=more_on" target="_blank" class="captionShow" style="height:77px;">
      ...
      <div class="element">   
        <a href="http://www.wwd.com/markets-news/ready-to-wear-sportswear/exclusively-at-enk-vegas-7442819" target="_blank" class="captionShow" style="height:77px;">
          <span class="publication" target="_blank">WWD</span>
          <br />
      ...
      <div class="element">   
        <a href="http://www.wwd.com/markets-news/markets-features/las-vegas-shows-at-a-glance-7442519?src=search_links" target="_blank" class="captionShow" style="height:77px;">
          <span class="publication" target="_blank">WWD</span>
          <br />
      ...
      <div class="element">   
        <a href="http://blog.trendstop.com/2013/10/enk-vegas-springsummer-2014-in-collaboration-with-fashionedits/" target="_blank" class="captionShow" style="height:77px;">
          <span class="publication" target="_blank">Trendstop</span>
          <br />
      ...
      <div class="element" >   
        <a href="http://issuu.com/dailyfrontrow/docs/dailystylist08192013" target="_blank" class="captionShow" style="height:55px;">
      ...
      <div class="element" >   
        <a href="http://fashionbeyondfashion.wordpress.com/2013/07/28/minimalism-elegance-comfort-the-los-angeles-fashion-story-featuring-kao-pao-shu-by-marco-schillaci/" target="_blank" class="captionShow" style="height:88px;">
          <span class="publication" target="_blank">Fashion Beyond Fashion</span>
          <br />
      ...
      <div class="element" >   
        <a href="http://www.latimes.com/features/image/la-ig-michael-stars-20130623,0,5022207.story" target="_blank" class="captionShow" style="height:65px;">
          <span class="publication" target="_blank">LA Times</span>
          <br />
      ...
      <div class="element" >   
        <a href="http://business.financialpost.com/2013/06/02/how-indie-clothing-company-preloved-reclaimed-its-street-cred/" target="_blank" class="captionShow" style="height:88px;">
          <span class="publication" target="_blank">Financial Post</span>
          <br />
      ...
      <div class="element" >   
        <a href="http://fashionbeyondfashion.wordpress.com/2013/06/23/the-elegant-minimalism-of-bags-by-kao-pao-shu/" target="_blank" class="captionShow" style="height:77px;">
          <span class="publication" target="_blank">Fashion Beyond Fashion</span>
          <br />
