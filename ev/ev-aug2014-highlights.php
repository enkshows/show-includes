<div id="highlights" class="module">
  ...
  <div class="module-content" style="margin-top:0;">
    ...
    <h5 class="who">– Rita Manzalman, senior buyer, Miss Jackson’s</h5>
  ...
  <div class="module-content" style="margin-top: 0;">
    ...
    <div class="image-lg">
      <a href="http://enkvegaslookbook.enkshows.com/" target="_blank" title="ENKVEGAS Digital Lookbook" >
        <img src="../../../img/shows/vegas/news/lookbook_aug.jpg" width="370" height="130">
      </a>
    </div>
    <div class="descbox1"> 
      <div id="news5">
        An interactive lookbook featuring a hand selected group of ENKVEGAS designers.<br/><br/>
        <a href="http://enkvegaslookbook.enkshows.com/" target="_blank">See Lookbook</a><br/><br/>
      </div>
    </div>    
    <div style="margin-top:20px;" class="text-foot"></div> 
  </div>
    ...
    <div class="imagePressBox">
      <div class="element">   
        <a href="http://blog.trendstop.com/2013/10/enk-vegas-springsummer-2014-in-collaboration-with-fashionedits/" target="_blank" class="captionShow" style="height:77px;">
          <span class="publication" target="_blank">Trendstop</span><br />
      ...
      <div class="element" >   
        <a href="http://issuu.com/dailyfrontrow/docs/dailystylist08192013" target="_blank" class="captionShow" style="height:55px;">
          <span class="publication" target="_blank">The Daily</span><br />
      ...
      <div class="element" >   
        <a href="http://www.latimes.com/features/image/alltherage/la-ar-calleen-cordero-opens-new-stores-summer-sale-20130709,0,2402013.story" target="_blank" class="captionShow" style="height:77px;">
          <span class="publication" target="_blank">LA Times</span><br />
      ...
      <div class="element" >   
        <a href="http://fashionbeyondfashion.wordpress.com/2013/07/28/minimalism-elegance-comfort-the-los-angeles-fashion-story-featuring-kao-pao-shu-by-marco-schillaci/" target="_blank" class="captionShow" style="height:88px;">
          <span class="publication" target="_blank">Fashion Beyond Fashion</span><br />
      ...
      <div class="element" >   
        <a href="http://business.financialpost.com/2013/06/02/how-indie-clothing-company-preloved-reclaimed-its-street-cred/" target="_blank" class="captionShow" style="height:88px;">
          <span class="publication" target="_blank">Financial Post</span><br />
