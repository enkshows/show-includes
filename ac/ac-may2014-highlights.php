<div id="highlights" class="module">
  ...
  <div class="module-content" style="margin-top:0;">
    ...
    <div class="image-lg">
      <a href="http://aciclookbook.enkshows.com/" target="_blank" title="Circuit.Intermezzo Digital Lookbook" >
        <img src="../../../../../img/shows/acic/2014/jan/acic-lookbook-snap.png" width="370" height="130">
      </a>
    </div>
    <div class="descbox1"> 
      <div id="news4">
  ...
  <div class="module-content" style="margin-top:0;">
    ...
    <div class="image-lg">
      <a href="http://fraichelookbook.enkshows.com/" target="_blank" title="Fraiche @ Circuit Digital Lookbook" >
        <img src="../../../../../img/shows/acic/highlights/fr-2014-jan-lookbook.png" width="370" height="130">
      </a>
    </div>
    <div class="descbox1"> 
      <div id="news2">
    ...
    <div style="margin-top:20px;" class="text-foot"></div>
  </div><!-- Fraiche Lookbook -->

  <div class="module-content" style="margin-top:0;">
    <h2>Sneak Peek @ Circuit.Intermezzo January 2014</h2>
    <div class="descbox3"> 
    A hand selected trend board highlighting Circuit.Intermezzo designers.<br/><br/>
      <div id="news3" >
  ...
  <div class="module-content" style="margin-top:0;">
    ...
    <div class="imagePressBox">
      ...
      <div class="element" >   
        <a href="http://www.runwaystop.com/article/6/enk_intermezzo_collections_and_accessorie_circuit/ " target="_blank" class="captionShow" style="height:55px;">
          <span class="publication" target="_blank">Runway Stop </span>
          <br />
          <span class="article" target="_blank">Circuit/Intermezzo Provides Buyers with Significant Options</span>
        </a>
        <a href="http://www.runwaystop.com/article/6/enk_intermezzo_collections_and_accessorie_circuit/ " target="_blank">
          <img src="../../../img/shows/acic/press/press_runway.jpg" />
        </a>
      </div>

      <div class="element" >   
        <a href="http://www.wwd.com/accessories-news/trends/colors-convenience-dominate-accessories-trade-shows-7356182" target="_blank" class="captionShow" style="height:55px;">
          <span class="publication" target="_blank">WWD</span>
          <br />
          <span class="article" target="_blank">Colors, Convenience Dominate Accessories Shows</span>
        </a>
        <a href="http://www.wwd.com/accessories-news/trends/colors-convenience-dominate-accessories-trade-shows-7356182" target="_blank">
          <img src="../../../img/shows/acic/press/press_wwd.jpg" />
        </a>
      </div>
