...
<div class="module-content-info">
  ...
  <?php include('../includes/ac/ac-form-exhibitor-app.php'); ?>

  <?php include('../includes/ac/ac-form-visit.php'); ?>

  <?php include('../includes/ac/ac-form-contact.php'); ?>

  <?php include('../includes/ac/ac-shows.php'); ?>
