...
<div class="module-content-info">
  ...
  <?php include('../includes/sc/sc-form-exhibitor-app.php'); ?>

  <?php include('../includes/sc/sc-form-visit.php'); ?>

  <?php include('../includes/sc/sc-form-contact.php'); ?>

  <?php include('../includes/sc/sc-shows.php'); ?>
